...
export const EBIKE_API_URL = "https://gbfs.lyft.com/gbfs/2.3/bkn/en/station_status.json"
export const REFRESH_INTERVAL_MS = 30 * 1000
export const CARROLL_ST_STATION_ID = "66de1fe7-0aca-11e7-82f6-3863bb44ef7c"
export const FIFTH_AVE_AND_THIRD_ST_STATION_ID = "66de2199-0aca-11e7-82f6-3863bb44ef7c";
export const FIRST_ST_AND_SIXTH_AVE_STATION_ID = "8066575c-f8e9-4e14-95ea-8d25ceeae2ca"
export const CARROLL_ST_AND_SIXTH_AVE_STATION_ID = "66de1ea2-0aca-11e7-82f6-3863bb44ef7c"
export const PRESIDENT_AVE_AND_FOURTH_AVE = "bca594e5-779f-4866-bd6b-818871f97d38"
export const UNION_ST_AND_FOURTH_AVE = "66de0d91-0aca-11e7-82f6-3863bb44ef7c"
